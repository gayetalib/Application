 ...
 */
final class Version20190714135008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE approvisionnement (id INT AUTO_INCREMENT NOT NULL, fournisseurs_id INT NOT NULL, articles_id INT NOT NULL, numero_commande INT NOT NULL, date_entree DATETIME NOT NULL, quantite_approv INT NOT NULL, INDEX IDX_516C3FAA27ACDDFD (fournisseurs_id), INDEX IDX_516C3FAA1EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE consommation (id INT AUTO_INCREMENT NOT NULL, services_id INT NOT NULL, articles_id INT NOT NULL, date_consommation DATETIME NOT NULL, quantite_cons INT NOT NULL, INDEX IDX_F993F0A2AEF5A6C1 (services_id), INDEX IDX_F993F0A21EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE departement (id INT AUTO_INCREMENT NOT NULL, directions_id INT NOT NULL, nom_departement VARCHAR(255) NOT NULL, INDEX IDX_C1765B6389B5C81B (directions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, departements_id INT NOT NULL, nom_service VARCHAR(255) NOT NULL, INDEX IDX_E19D9AD21DB279A6 (departements_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
